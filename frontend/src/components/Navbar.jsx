...
const Navbar = () => {
  ...
  return (
    // menu will be hidden and for small and above screen it will be flex ...
    <div className="flex items-center justify-between py-5  font-medium">
      ...
      {/* Search, Profile and Shopping cart */}
      ...
      {/* Sidebar Menu For Small Screens, show when the isVisible= true */}
      <div
        // using dynamic className if true w-full if not w-0
